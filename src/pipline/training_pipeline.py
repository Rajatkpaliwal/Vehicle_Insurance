...
class TrainPipeline:
    ...
    def start_data_validation(self, data_ingestion_artifact: DataIngestionArtifact) -> DataValidationArtifact:
        """
        This method of trainPipeline class is responsible for testing data validation component
        """
    ...
    def run_pipeline(self) -> None:
        """
        This method of TrainPipeline class is responsible for running complete piepline
        """
        try:
